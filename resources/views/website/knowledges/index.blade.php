            ...
            <div class="row">
                @forelse ($knowledges as $item)
                    <div class="col-sm-3 col-lg-3 col-md-3">
                        <div class="thumbnail">
                            <img src="{{ ($item->attachments()->count() == 0) ? asset('images/320x150.png') : url('/attachment/' . $item->attachments()->where('attach_type', 'document')->first()->file) }}" alt="" style="max-height: 122px;">
                            <div class="caption">
                ...
                @empty
                    <div class="col-sm-12 col-lg-12 col-md-12" style="padding: 150px 0px;">
                        <h4><i class="fa fa-commenting fa-fw"></i> ไม่มีสาระน่ารู้</h>
                    </div>
                @endforelse
            </div>
        </div>

...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ตรวจสอบความสามารถในการค้ำประกันผู้อื่น
            <small>ตรวจสอบความสามารถในการค้ำประกันเงินของกู้ผู้อื่น</small>
        </h1>

        @include('admin.layouts.breadcrumb', ['breadcrumb' => [
            ['item' => 'ตรวจสอบความสามารถในการค้ำประกันผู้อื่น', 'link' => ''],
        ]])
    </section>
    ...
    <section class="content">
        <!-- Info boxes -->
        <div class="well">
            <h4>ตรวจสอบความสามารถในการค้ำประกันผู้อื่น</h4>
            <p>ให้ผู้ดูแลระบบสามารถตรวจสอบความสามารถในการค้ำประกันเงินกู้ของผู้อื่น</p>
        </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="membercode">รหัสสมาชิกของผู้ค้ำ</label>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-info">
                        ...
                        <tr>
                            <th>ค้ำประกันผู้อื่น:</th>
                            <td><span id="bailsman"></span></td>
                        </tr> 
                        <tr>
                            <th>ค้ำประกันตนเอง:</th>
                            <td><span id="yourself"></span></td>
                        </tr> 
                        <tr>
                            <th>สามารถค้ำได้เป็นจำนวนเงิน:</th>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header panel-heading">
                    ...
                    <h4 class="modal-title">ความสามารถในการค้ำประกันผู้อื่น</h4>
                </div>
    ...
    function check_employee(id, salary, netsalary) {
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#bailsman').html($.number(result.bailsman, 0) + ' สัญญา' + ((result.bailsman > 0) ? ' <a href=\"/service/' + parseInt(result.member_code) + '/guaruntee\">[ดูรายละเอียดการค้ำประกัน]</a>' : ''));
                $('#yourself').html($.number(result.yourself, 2) + ' บาท');

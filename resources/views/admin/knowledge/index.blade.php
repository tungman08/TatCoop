        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <button class="btn btn-primary btn-flat margin-b-md" type="button" data-tooltip="true" title="เพิ่มสาระน่ารู้"
                    onclick="javascript:document.location.href='{{ action('Admin\KnowledgeController@create') }}';">
                ...
                <button class="btn btn-default btn-flat margin-b-md pull-right" type="button" data-tooltip="true" title="สาระน่ารู้ที่ถูกลบ"
                    onclick="javascript:document.location.href='{{ action('Admin\KnowledgeController@getInactive') }}';">
                ...
                <div class="table-responsive" style=" margin-top: 10px;">
                    <table id="dataTables-knowledges" class="table table-hover dataTable" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr onclick="javascript: document.location.href  = '{{ action('Admin\KnowledgeController@show', ['id'=>$knowledge->id]) }}';"
                                style="cursor: pointer;">
                                <td>{{ $index + 1 }}.</td>
                                <td class="text-primary"><i class="fa fa-commenting fa-fw"></i> {{ $knowledge->title }}</td>
                                <td>{{ Diamond::parse($knowledge->created_at)->thai_format('Y-m-d') }}</td>
                            </tr>
                            @endforeach
                        </tbody>                     
                    </table>

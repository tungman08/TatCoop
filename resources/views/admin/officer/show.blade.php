        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-info">
                        <tr>
                            ...
                            <td style="border-top: 1px solid #ffffff;">{{ $user->fullname }}</td>
                        </tr>
                        <tr>
                            <th>อีเมล:</th>
                            <td>{{ $user->email }}</td>
                ...
                <button class="btn btn-primary btn-flat"
                    onclick="javascript:document.location.href = '{{ action('Admin\AdminController@edit', ['id' => $user->id]) }}';">
            ...
            <div class="box-body">
                <div class="table-responsive" style=" margin-top: 10px;">
                    <table id="dataTables-history" class="table table-hover dataTable" width="100%">
                        ...
                        <tbody>
                            @php($count = 0)
                            @foreach($user->admin_histories->sortByDesc('created_at')->take(300) as $history)
                            <tr>
                                <td>{{ ++$count }}.</td>

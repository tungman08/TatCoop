...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ตรวจสอบสัญญาเงินกู้ที่ผ่อนชำระหมดแล้ว
            <small>แสดงรายการสัญญาเงินกู้ทุกประเภทที่ผ่อนชำระหมดแล้ว</small>
        </h1>

        @include('admin.layouts.breadcrumb', ['breadcrumb' => [
            ['item' => 'ตรวจสอบสัญญาเงินกู้ฯ', 'link' => '/admin/activeloan'],
            ['item' => 'สัญญาที่ชำระหมดแล้ว', 'link' => ''],
        ]])
    </section>
        ...
        <!-- Info boxes -->
        <div class="well">
            <h4>ตรวจสอบสัญญาเงินกู้ที่ผ่อนชำระหมดแล้ว</h4>
            <p>ให้ผู้ดูแลระบบสามารถดูรายการสัญญาเงินกู้ทุกประเภทที่ผ่อนชำระหมดแล้ว</p>
        </div>

        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-money"></i> สัญญาเงินกู้ที่ผ่อนชำระหมดแล้ว</h3>
            </div>
            <!-- /.box-header -->

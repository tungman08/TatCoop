...
@section('content')
    ...
    <section class="content">
        <div class="well">
            <h4>แสดงข้อมูลคณะกรรมการที่ถูกลบ</h4>
            <p>สามารถคืนค่าให้กับบัญชีผู้ใช้งานระบบที่ถูกลบไปแล้ว</p>
        </div>
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">บัญชีคณะกรรมการ</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
                ...
                <div class="table-responsive">
                    ...
                    {{ Form::open(['action' => ['Admin\BoardController@postRestore', 0], 'id' => 'restore_form', 'method' => 'post', 'role' => 'form', 'onsubmit' => "return confirm('คุณต้องการคืนค่าคณะกรรมการใช่หรือไม่??');"]) }}
                    {{ Form::close() }}

                    {{ Form::open(['action' => ['Admin\BoardController@postForceDelete', 0], 'id' => 'forcedelete_form', 'method' => 'post', 'role' => 'form', 'onsubmit' => "return confirm('คุณต้องการลบคณะกรรมการนี้ใช่ไหม?');"]) }}
                    {{ Form::close() }}
                </div>
                <!-- /.table-responsive -->
            </div>

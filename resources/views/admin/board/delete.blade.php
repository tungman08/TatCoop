    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-trash fa-fw"></i> ลบบัญชีคณะกรรมการ</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                {{ Form::open(['action' => ['Admin\BoardController@destroy', $board->id], 'method' => 'delete', 'role' => 'form']) }}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('email', 'บัญชีผู้ใช้งาน [' . $board->email . ']') }}

...
@section('content')
    ...
    <section class="content-header">
        ...
        @include('admin.layouts.breadcrumb', ['breadcrumb' => [
            ...
            ['item' => 'การกู้ยืม', 'link' => 'service/' . $loan->member_id . '/loan'],
        ...
        <div class="row">      
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-file-text-o fa-fw"></i> ทำสัญญาเงินกู้ประเภทกู้ฉุกเฉิน</h3>
                    </div>
                    <!-- /.box-header -->

                    <!-- form start -->
                    {{ Form::model($loan, ['url' => '/service/' . $loan->member_id . '/loan/create/emerging/outsider', 'method' => 'post', 'class' => 'form-horizontal']) }}
                        {{ Form::hidden('id', null, ['id' => 'id']) }}
                        {{ Form::hidden('member_id', null, ['id' => 'member_id']) }}

                        @include('admin.loan.create.emerging.outsider.form')
                    {{ Form::close() }}
                </div>
                <!-- /.box -->
            </div>
            ...
            <div class="col-md-4">
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        @include('admin.loan.loantype', ['loantype' => App\LoanType::find(2)])
                    </div>          
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->

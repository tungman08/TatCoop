        ...
        <div class="row">      
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    {{ Form::model($loan, ['action' => ['Admin\SpecialLoanController@getCreateEmployeeLoan', $loan->member_id], 'method' => 'post', 'class' => 'form-horizontal']) }}
                        {{ Form::hidden('id', null, ['id' => 'id']) }}
                        {{ Form::hidden('member_id', null, ['id' => 'member_id']) }}

                        @include('admin.loan.create.special.employee.form')
                    {{ Form::close() }}
                </div>
                <!-- /.box -->
            </div>

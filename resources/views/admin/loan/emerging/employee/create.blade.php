    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-file-o"></i> ทำสัญญาเงินกู้ประเภทกู้ฉุกเฉิน สำหรับพนักงาน/ลูกจ้าง ททท.</h3>
            </div>
            <!-- /.box-header -->
            ...
            {{ Form::open(['url' => '/admin/member/' . $member->id . '/loan', 'method' => 'post', 'class' => 'form-horizontal']) }}
                ...
                @include('admin.loan.emerging.employee.form', ['edit' => false])
            {{ Form::close() }}
        </div>
        <!-- /.box -->

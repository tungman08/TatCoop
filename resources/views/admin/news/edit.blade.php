...
@section('content')
    ...
    <section class="content-header">
        ...
        @include('admin.layouts.breadcrumb', ['breadcrumb' => [
            ...
            ['item' => 'แสดงรายละเอียด', 'link' => action('Admin\NewsController@show', ['id'=>$news->id])],
            ['item' => 'แก้ไข', 'link' => ''],
        ]])
    ...
    <section class="content">
        <!-- Info boxes -->
        <div class="well">
            <h4>แก้ไขข่าวสารสำหรับสมาชิก</h4>
            <p>ให้ผู้ดูแลระบบ แก้ไขข่าวสารสำหรับสมาชิก</p>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    {{ Form::model($news, ['action' => ['Admin\NewsController@update', $news->id], 'method' => 'put', 'class' => 'form-horizontal']) }}
            ...
            <div class="col-md-4">
                ...
                <div class="box box-default">
                    ...
                    @include('admin.news.image', ['images' => $news->attachments()->where('attach_type', 'photo')->get() ])
                </div>
                <!-- /.box -->
            </div>
            <!-- /.col -->

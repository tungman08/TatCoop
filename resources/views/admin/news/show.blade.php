...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-default btn-flat btn-xs"
                        onclick="javascript:document.location.href='{{ action('Admin\NewsController@edit', ['id'=>$news->id]) }}';">
                        แก้ไข
                    </button>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a style="cursor: pointer;" onclick="javascript:document.location.href='{{ action('Admin\NewsController@edit', ['id'=>$news->id]) }}';"><i class="fa fa-edit"></i> แก้ไข</a></li>
            ...
            {{ Form::open(['action' => ['Admin\NewsController@destroy', $news->id], 'method' => 'delete', 'id' => 'delete_form']) }}
            {{ Form::close() }}            

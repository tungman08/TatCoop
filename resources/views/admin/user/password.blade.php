                            ...
                            <div class=" col-md-9 col-lg-9 ">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::password('password', ['required', 'class'=>'form-control', 'placeholder'=>'Current Password', 'style'=>'position: initial;']) }}
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        {{ Form::password('new_password', ['required', 'class'=>'form-control', 'placeholder'=>'New Password', 'style'=>'position: initial;']) }}
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        {{ Form::password('new_password_confirmation', ['required', 'class'=>'form-control', 'placeholder'=>'Confirm Password', 'style'=>'position: initial;']) }}

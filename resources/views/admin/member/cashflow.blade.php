...
@section('content')
    ...
    <section class="content">
        ...
        <div class="well">
            ...
            <a href="{{ action('Admin\MemberController@getPrintCashflow', ['id'=>$member->id, 'year'=>$year]) }}" target="_blank" class="btn btn-default btn-flat"><i class="fa fa-print"></i> พิมพ์</a>
            <button type="button"
                class="btn btn-primary btn-flat pull-right"
                style="margin-right: 5px;"
                onclick="javascript:document.location.href  = '{{ action('Admin\MemberController@getPrintPdfCashflow', ['id'=>$member->id, 'year'=>$year]) }}';">

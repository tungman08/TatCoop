...
@section('content')
    ...
    <section class="content">
        <!-- Info boxes -->
        <div class="well">
            <h4>การกู้ยืมสมาชิกสหกรณ์</h4>
            <p>ให้ผู้ดูแลระบบสามารถจัดการการกู้ยืมและผ่อนชำระหนี้ของ {{ $member->profile->fullName }}</p>
        </div>
